...
class TestCvM : public StatisticalTest_AfterEVT<T_INPUT, T_TIME> {
...
public:
     ...
     */
    TestCvM(double significance_level, distribution_t distribution_type)
