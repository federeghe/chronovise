...
class Test_LjungBox_Test : public ::testing::Test {
protected:


};

TEST_F(Test_LjungBox_Test, GetterSetter) {
    TestLjungBox<unsigned long, unsigned long> jb(0.01, 10);
...
TEST_F(Test_LjungBox_Test, DistributionACCEPT) {

    TestLjungBox<unsigned int, double> jb(0.05, 5);
...
TEST_F(Test_LjungBox_Test, DistributionREJECT_1) {
...
TEST_F(Test_LjungBox_Test, DistributionREJECT_2) {

    TestLjungBox<unsigned int, double> jb(0.05, 2);
...
TEST_F(Test_LjungBox_Test, DistributionREJECT_3) {

    TestLjungBox<unsigned int, double> jb(0.05, 10);
...
,-1.9330,-0.4390,-1.7947,0.8404
    ...
    for (int i=0; i<100; i++) {
        ...
        mp1.push(i, norm_ind_values[i] + old);
        mp2.push(i, norm_ind_values[i]);
    }
