...
class Test_BDS_Test : public ::testing::Test {
protected:


};

TEST_F(Test_BDS_Test, GetterSetter) {
    TestBDS<unsigned long, unsigned long> jb(0.01);
...
TEST_F(Test_BDS_Test, DistributionREJECT_1) {
...
TEST_F(Test_BDS_Test, DistributionREJECT_2) {
