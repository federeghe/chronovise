...
class Test_RS_Test : public ::testing::Test {
protected:


};

TEST_F(Test_RS_Test, GetterSetter) {
    TestRS<unsigned long, unsigned long> jb(0.01);
...
TEST_F(Test_RS_Test, DistributionACCEPT) {

    TestRS<unsigned int, double> jb(0.05);
...
TEST_F(Test_RS_Test, DistributionREJECT_1) {
...
TEST_F(Test_RS_Test, DistributionREJECT_2) {
